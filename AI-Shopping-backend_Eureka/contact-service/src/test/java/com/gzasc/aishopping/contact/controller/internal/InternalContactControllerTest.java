...
class InternalContactControllerTest {
    ...
    void getContactById_success() throws Exception {
        ...
        when(userContactService.g(1)).thenReturn(contact);
    ...
    void getContactById_notFound() throws Exception {
        when(userContactService.g(99999)).thenReturn(null);
    ...
    void getContactById_invalidId() throws Exception {
        when(userContactService.g(0)).thenReturn(null);
        when(userContactService.g(-1)).thenReturn(null);
